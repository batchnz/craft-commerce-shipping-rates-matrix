...
namespace batchnz\ccshippingratesmatrix\fields;

use batchnz\ccshippingratesmatrix\Plugin;
use batchnz\ccshippingratesmatrix\assetbundles\shippingratesfield\ShippingRatesFieldAsset;
 ...
 * @since     1.0.0
 */
class ShippingRates extends Field
{
    // Static Methods
    // =========================================================================
    ...
    {
        return Craft::t('craft-commerce-shipping-rates-matrix', 'Shipping Rates Matrix');
    }
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'craft-commerce-shipping-rates-matrix/_components/fields/ShippingRatesField_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerAssetBundle(ShippingRatesFieldAsset::class);
        ...
        return Craft::$app->getView()->renderTemplate(
            'craft-commerce-shipping-rates-matrix/_components/fields/ShippingRatesField_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
